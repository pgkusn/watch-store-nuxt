        ...
        <div class="hero bg-cover" style="background-image: url(images/hero.jpg)">
            <div class="container h-[480px] md:h-[870px] flex items-center">
                <div class="text-white max-w-[350px] md:max-w-[445px] mx-auto md:mr-0 md:ml-auto" data-aos="fade-left">
                    ...
                    <nuxt-link to="/products" class="home-btn text-[28px] border-white mt-4">
                        Shop now
                    </nuxt-link>
                </div>
            </div>
            ...
            <section class="flex flex-col items-center md:flex-row" data-aos="fade-right">
                ...
                <div class="md:w-0 md:flex-grow flex justify-center items-center">
                    <div class="max-w-[382px] p-4">
                        ...
                        <nuxt-link to="/product/1" class="inline-block text-coral-black font-bold mt-2 md:mt-4">
                            查看更多
                        </nuxt-link>
                    </div>
                </div>
            ...
            <section class="flex flex-col items-center md:flex-row" data-aos="fade-left">
                ...
                <div class="md:w-0 md:flex-grow flex justify-center items-center">
                    <div class="max-w-[382px] p-4">
                        ...
                        <nuxt-link to="/product/12" class="inline-block text-coral-black font-bold mt-2 md:mt-4">
                            查看更多
                        </nuxt-link>
                    </div>
                </div>
            ...
            <section class="flex flex-col items-center md:flex-row" data-aos="fade-right">
                ...
                <div class="md:w-0 md:flex-grow flex justify-center items-center">
                    <div class="max-w-[382px] p-4">
                        ...
                        <nuxt-link to="/product/13" class="inline-block text-coral-black font-bold mt-2 md:mt-4">
                            查看更多
                        </nuxt-link>
                    </div>
                </div>
